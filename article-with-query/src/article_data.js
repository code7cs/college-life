const article_data = [
    ...
    },
    {
        id: 2,
        topic: "CS554",
        title: "Elite College Admissions Are a Zero-Sum Game",
        author: "Scott Galloway",
        content:
            "State-sponsored education is who I am, and how I got here. Admittance to UCLA is singular. No other event or action has had a more positive impact on my life and the lives of people around me.It’s easy to credit your character and hard work for your success, and the market for your failures. I have no such delusions. And, to be clear, I’m not modest… I believe I’m talented, maybe even in the top 1%. Yeah, BFD… that gets you entry into a room with 75 million other people (nearly the population of Germany). There are two reasons for my success: my mom’s irrational passion for my well-being, and being born in California.The astronomical costs of college and rising student debt are part of a revolution, in its early stages, as income inequality reaches a tipping point. Historically, when we see this type of wealth concentration, one of three correcting mechanisms takes place: war, famine, or revolution. The middle class and capitalism are the gears that turned back Hitler and AIDS, and the lubricant for the middle class is education. We are now throwing sand in the gears of upward mobility for the middle class. For the first time, 30-year-olds are worse off than their parents were at 30. Kids aren’t getting into schools as prestigious as their parents’. For many families this is the first encounter with technicolor inequality, where being in any cohort other than the top 1% means the leaves of opportunity are shedding prematurely from your family tree. How many in our generation say, about the college we attended, “I couldn’t get in today”? From 2006 to 2018, the acceptance rate among the top 50 US universities fell 36% and declined even more among the top 10 universities (60%). Stanford has an admissions rate of 4%; Harvard — 5%. The fact that your gene pool is no longer bound for UCLA but Pepperdine feels like you’ve failed as a parent. The thrust on the fuselage for the first 10 years of a kid’s adult life is the school you did or didn’t get them into. And let’s be honest, any appraisal of a 17-year-old is an appraisal of their parents. Your son wearing your old Stanford shirt until he gets rejected and ends up at UNLV is the grist for our budding revolution where people give up on capitalism and turn to populism or PG-13 socialism.",
        link: "https://medium.com/s/no-mercy-no-malice/how-i-got-here-eb3ca0aa98d2"
    },
    {
        id: 3,
        topic: "CS555",
        title: "Meet the World’s Most Bio-Tracked Man",
        author: "Dana G Smith",
        content:
            "ichael Snyder might be the most bio-tracked man in the world. He’s tested 14 of his “-omes,” such as the standard genome and microbiome as well as the less-well-known metabolome, transcriptome, proteome, immunome, and exposome. At any given time, he has eight devices on or around his body tracking his heart rate, blood oxygen, step count, blood glucose, radiation exposure, and even the surrounding air quality. “It’s data galore,” says the Stanford University genetics professor on a recent Saturday afternoon at his office. Snyder is an animated talker and quick to laugh, with deep smile lines around his eyes. He is a man who loves what he does, and it shows. “I’m a pretty big nerd,” he says. “Here I am on a Saturday. That probably tells you all you need to know.”",
        link: "https://onezero.medium.com/meet-the-worlds-most-bio-tracked-man-2077758cf5a2"
    },
    {
        id: 4,
        topic: "CS554",
        title: "U.S.-China Trade Standoff May Be Initial Skirmish in Broader Economic War",
        author: "Ana Swanson and Keith BradSher",
        content:
            "WASHINGTON — A yearlong trade war between the United States and China is proving to be an initial skirmish in an economic conflict that may persist for decades, as both countries battle for global dominance, stature and wealth. Progress toward a trade agreement nearly collapsed this past week, with both sides hardening their bargaining positions. And even if a trade deal is reached, it may do little to resolve tensions between the world’s two largest economies.",
        link: "https://www.nytimes.com/2019/05/11/world/asia/us-china-trade-war.html"
    },
    {
        id: 5,
        topic: "CS546",
    ...
    },
    {
        id: 6,
        topic: "CS442",
        title: "WORLD Nearly every country in the world approves pact to reduce plastic pollution, except the U.S.",
        ...
        link:
            "https://www.nbcnews.com/news/world/nearly-every-country-world-approves-pact-reduce-plastic-pollution-except-n1004626"
    },
    {
        id: 7,
        topic: "CS554",
        title: "Wedding costs are out of control — for the guests. But I still love going to them",
        ...
        link:
            "https://www.nbcnews.com/think/opinion/wedding-costs-are-out-control-guests-i-still-love-going-ncna1004396"
    },
    {
        id: 8,
        topic: "CS511",
        title: "Trump may be underestimating Iran's resolve in resisting nuclear sanctions",
        author: "Andrea Mitchell",
        content:
            "As Secretary of State Mike Pompeo appeared to be sounding the drums of war against Iran Thursday, and U.S. warships were steaming toward the region, a reporter asked President Donald Trump if there is a risk of military confrontation.",
        link:
    ...
    },
    {
        id: 9,
        topic: "CS554",
        title: "Name of Thrones: Parents are naming their kids after favorite 'GoT' characters",
        author: "Joe Murphy",
        content:
            "For the 319 baby girls born and named Lyanna last year, “Game of Thrones” will never end. More parents are bestowing “Game of Thrones” character names on their children than ever, according to Social Security Administration data published Friday. Excluding the Jons and Jaimes, more than 4,500 children were given such names in 2018, up from the 3,800-plus in 2017 and the more than 3,200 in 2016.",
        link: "https://www.nbcnews.com/pop-culture/tv/lil-joffrey-game-thrones-baby-names-n1004541"
    },
    {
        id: 10,
        topic: "CS392",
        title: "Sen. Chris Murphy calls for probe into Giuliani efforts in Ukraine on behalf of Trump",
        author: "By Allan Smith and Dartunorro Clark",
        content:
        ...
        link:
            "https://www.nbcnews.com/politics/politics-news/sen-chris-murphy-calls-probe-giuliani-s-efforts-ukraine-behalf-n1004551"
    }
];
